        ...
        <div class="col-md-12">
            <table class="table">
                ...
                <tr>
                    ...
                    <th style="text-align: center" class="col-md-2">Fields</th>
                    <th style="text-align: center" class="col-md-2">Created On</th>
                    <th style="text-align: center" class="col-md-2">Finished On</th>
                </tr>
                </thead>
                <tbody>
                ...
                <#list data.exprList as expr>
                    <tr id="${expr.id}">
                        ...
                        <td style="vertical-align: middle;">
                            <input type="text" value="${expr.finishedDate}" disabled cols="20" class="form-control" id="exprfinishedDate"
                                      name="exprfinishedDate">
                        </td>
                    </tr>
                    </#list>
                    </#if></#if>
